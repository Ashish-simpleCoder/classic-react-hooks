...
hero:
   name: 'classic-react-hooks'
   tagline: Collection of <span style="text-decoration-line:underline;text-decoration-style:wavy">feature</span> packed custom hooks
   actions:
      - theme: brand
        text: Get Started
